...
const introInfo = {
    about: `Na adoção uma criança ou adolescente é acolhido por uma família, passando a ser filho ou filha na sua integralidade.`,
    projects: `Pra acessar vc faz isso e aquilo. Pra acessar vc faz isso e aquilo. Pra acessar vc faz isso e aquilo. Pra acessar vc faz isso e aquilo. Pra acessar vc faz isso e aquilo. Pra acessar vc faz isso e aquilo. Pra acessar vc faz isso e aquilo. Pra acessar vc faz isso e aquilo. Pra acessar vc faz isso e aquilo. Pra acessar vc faz isso e aquilo. Pra acessar vc faz isso e aquilo. 
    Acesse o site do PJe. Para ingressar no sistema, informe o seu certificado digital ou o seu login (CPF ou CNPJ) e senha.`,
    specialized_rods: 'A consulta pública serve pra fazer isso e aquilo. Pra acesar você faz isso e aquilo.'
}
