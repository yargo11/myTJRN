...
export default function ServiceAndInformationCard ({ description, label, link }:TopicBoxInterface) {
    ...
    return (
        <Box as={Link} href={link} w='full' minH={{ base: '109px',sm:'168px', md:'227px', lg:'285px' }} pt={{ base: '16px', sm:'30.71px', md:'45.42px', lg:'60.13px' }} pb='18px' px='24px' border='1px' borderColor='#D8DBDF' borderRadius='md'>
